...
export default function ErrorPage({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-sakaland-black text-center px-4">
      <AlertTriangle className="w-10 h-10 text-sakaland-red mb-4" />
      ...
      <button
        onClick={reset}
        className="px-5 py-2.5 rounded-lg bg-sakaland-red text-white text-sm font-medium hover:bg-sakaland-redDark transition-colors"
      >
        Tentar novamente
      </button>
    </div>
